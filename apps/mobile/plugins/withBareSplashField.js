 ...
 * understanding that the launch opens on flat yellow and the mark then draws
 * itself on in JS (`AnimatedSplash`, `WaveMark`). That understanding was wrong
 * about Android.
 *
 ...
 * `android:icon` — `@mipmap/ic_launcher`, the navy tile with the lavender mark
 * on it. So the launch spent about three quarters of a second showing a
 * finished logo, then dissolved it and drew the same logo again in a different
 * colour on a different background. That is precisely the seam the splash was
 * rebuilt to remove, wearing a different hat.
 *
