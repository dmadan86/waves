...
export interface UiStrings {
  ...
  group: {
    ...
    heroExpense: string;
    /** A group row's standing, said small under its amount — the short form of
     *  youAreOwed / youOwe / allSettled. */
    rowOwed: string;
    rowYouOwe: string;
    rowSettled: string;
...
const en: UiStrings = {
  ...
  smsInbox: {
    ...
    scanFound: { one: 'Found {n} payment', other: 'Found {n} payments' },
    scanNothingNew: 'Nothing new since last time.',
    scanUnreadable: {
      one: '{n} message looked like a payment but could not be read.',
      other: '{n} messages looked like payments but could not be read.',
    },
    scanDrafted: {
...
const ta: UiStrings = {
  ...
  group: {
    ...
    rowOwed: 'owed', // English placeholder — English-first phase, translation owed
    rowYouOwe: 'you owe', // English placeholder
    rowSettled: 'settled', // English placeholder
  ...
  smsInbox: {
    ...
    scanFound: {
      one: '{n} பணப்பரிமாற்றம் கிடைத்தது',
      other: '{n} பணப்பரிமாற்றங்கள் கிடைத்தன',
    },
    scanNothingNew: 'கடந்த முறைக்குப் பிறகு புதிதாக ஒன்றுமில்லை.',
    scanUnreadable: {
      one: '{n} செய்தி பணப்பரிமாற்றம் போலத் தெரிந்தது, ஆனால் படிக்க முடியவில்லை.',
      other: '{n} செய்திகள் பணப்பரிமாற்றம் போலத் தெரிந்தன, ஆனால் படிக்க முடியவில்லை.',
    },
    scanDrafted: {
...
const hi: UiStrings = {
  ...
  smsInbox: {
    ...
    scanFound: { one: '{n} भुगतान मिला', other: '{n} भुगतान मिले' },
    scanNothingNew: 'पिछली बार के बाद कुछ नया नहीं।',
    scanUnreadable: {
      one: '{n} संदेश भुगतान जैसा लगा, पर पढ़ा नहीं जा सका।',
      other: '{n} संदेश भुगतान जैसे लगे, पर पढ़े नहीं जा सके।',
    },
    scanDrafted: {
...
const ar: UiStrings = {
  ...
  smsInbox: {
    ...
    scanFound: {
      ...
      two: 'عُثر على دفعتين',
      few: 'عُثر على {n} دفعات',
      many: 'عُثر على {n} دفعة',
      other: 'عُثر على {n} دفعة',
    },
    ...
    scanUnreadable: {
      ...
      few: '{n} رسائل بدت كدفعات وتعذّرت قراءتها.',
      many: '{n} رسالة بدت كدفعات وتعذّرت قراءتها.',
      other: '{n} رسالة بدت كدفعات وتعذّرت قراءتها.',
    },
    scanDrafted: {
      ...
      few: 'كانت {n} واضحة بما يكفي لتنتقل مباشرة إلى Review.',
    ...
    addToGroup: {
      ...
      few: 'أضف {n} إلى مجموعة',
      many: 'أضف {n} إلى مجموعة',
      other: 'أضف {n} إلى مجموعة',
    },
    setAside: {
      zero: 'نحِّ جانبًا',
      one: 'نحِّ جانبًا',
    ...
    setAsideDone: {
      ...
      few: 'نُحِّي {n} جانبًا',
      many: 'نُحِّي {n} جانبًا',
      other: 'نُحِّي {n} جانبًا',
    },
    placed: {
      zero: 'لم يُضَف شيء إلى {name}',
      one: 'أُضيف إلى {name}',
      two: 'أُضيف اثنان إلى {name}',
      few: 'أُضيف {n} إلى {name}',
      many: 'أُضيف {n} إلى {name}',
  ...
  timeline: {
    ...
    quietFor: { zero: 'بعد {n} ساعة', one: 'بعد ساعة', two: 'بعد ساعتين', few: 'بعد {n} ساعات', many: 'بعد {n} ساعة', other: 'بعد {n} ساعة' },
    noPlaceCount: { zero: 'لا مكان لـ {n}', one: 'واحد بلا مكان', two: 'اثنان بلا مكان', few: '{n} بلا مكان', many: '{n} بلا مكان', other: '{n} بلا مكان' },
    stops: { zero: '{n} محطة', one: 'محطة واحدة', two: 'محطتان', few: '{n} محطات', many: '{n} محطة', other: '{n} محطة' },
  },
  claims: {
